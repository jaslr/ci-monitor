...
const quickCommands = [
  QuickCommand(
    name: 'Service Status',
    description: 'Check orchon-bot service status',
    command: 'systemctl status orchon-bot --no-pager',
    icon: Icons.monitor_heart,
    color: Colors.blue,
  ),
  QuickCommand(
    name: 'Restart Bot',
    description: 'Restart the orchon-bot service',
    command: 'systemctl restart orchon-bot && systemctl status orchon-bot --no-pager',
    icon: Icons.refresh,
    color: Colors.orange,
  ),
  QuickCommand(
    ...
    command: 'journalctl -u orchon-bot -n 50 --no-pager',
    icon: Icons.article,
    color: Colors.green,
  ),
  QuickCommand(
    ...
    command: 'cd /root/orchon && git pull',
    icon: Icons.download,
    color: Colors.purple,
  ),
  QuickCommand(
    ...
    command: 'cd /root/orchon && git pull && systemctl restart orchon-bot && systemctl status orchon-bot --no-pager',
